...
!    rtot(inc) = sqrt( dx*dx + dy*dy )
     rtot(inc) = RADIUS * acos( sin(rlat(bon_1(inc),bon_2(inc))) &
                                * sin(rlat(i1,j1)) &
                                + cos(rlat(bon_1(inc),bon_2(inc))) &
                                * cos(rlat(i1,j1)) &
                                * cos(rlon(bon_1(inc),bon_2(inc)) - rlon(i1,j1)) )
  end do
...
!    rtot(inc) = sqrt( dx*dx + dy*dy )
     rtot(inc) = RADIUS * acos( sin(rlat(icand(inc),jcand(inc))) &
                                * sin(rlat(i1,j1)) &
                                + cos(rlat(icand(inc),jcand(inc))) &
                                * cos(rlat(i1,j1)) &
                                * cos(rlon(icand(inc),jcand(inc)) - rlon(i1,j1)) )
  end do
